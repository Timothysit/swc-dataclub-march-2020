...
<font size=4> <!-- .element: class="fragment" data-fragment-index="1" -->

- No previous study on high-dimensional audio-visual integration in mice. <!-- .element: class="fragment" data-fragment-index="1" -->
- Previous report of low-dimensional modulation of visual response by auditory stimuli may be constrained by low stimulus space dimensionality <!-- .element: class="fragment" data-fragment-index="2" -->

</font>
 
 <font size=5> <!-- .element: class="fragment" data-fragment-index="1" -->
...
*Stringer and Pachitariu 2019: High-dimensional geometry of population response in visual cortex* <!-- .element: class="fragment" data-fragment-index="1" --> 
 ...
 <font size=5> <!-- .element: class="fragment" data-fragment-index="2" -->

*Gao 2017: A theory of multineuronal dimensionality, dynamics and measurement* <!-- .element: class="fragment" data-fragment-index="2" -->
 ...
 **taking account of movement responses to stimuli** <!-- .element: class="fragment" data-fragment-index="1" --> <!--.element: style="color:red"-->

**2. What is the relationship between unimodal and multimodal response?** <!-- .element: class="fragment" data-fragment-index="3" --> 


<font size=4> <!-- .element: class="fragment" data-fragment-index="3" -->

- Single neuron question: how is tuning for one modality influenced by another modality? <!-- .element: class="fragment" data-fragment-index="3" --> 
- Population level question: In multimodal regions, do distinct neurons respond to audio and visual stimulus, or do neurons have mixed selectivity? Is this selectivity dependent on certain audio-visual statistics? (eg. coherent motion and sound energy) <!-- .element: class="fragment" data-fragment-index="3" -->
 
</font>

**3. What is the circuit architecture of audio-visual decision making?** <!-- .element: class="fragment" data-fragment-index="7" -->
...
![Face motion explains neural activity](./figures/citations/stringer-facemap-predict-neural.png) <!-- .element: class="fragment current-visible" data-fragment-index="1" -->

*Stringer and Pachitariu 2019: Spontaneous behaviors drive multidimensional, brainwide activity* <!-- .element: class="fragment current-visible" data-fragment-index="1" -->


![Where to find multimodal response](./figures/where_to_find_multimodal_response.png)  <!-- .element: class="fragment current-visible" data-fragment-index="2" -->


![Linear multimodal response](./figures/linear_multimodal_response.png)  <!-- .element: class="fragment current-visible" data-fragment-index="3" -->

$$f(A + V) = f(A) + f(V)$$  <!-- .element: class="fragment current-visible" data-fragment-index="3" -->



![Nonlinear multimodal response](./figures/nonlinear_multimodal_response.png) <!-- .element: class="fragment current-visible" data-fragment-index="4" -->

$$f(A + V) = f(A) + f(V) + f(A, V)$$ <!-- .element: class="fragment current-visible" data-fragment-index="4" -->

![Audiovisual subspace](./figures/intro-to-multimodal/multimodal-mixed-selectivity.svg) <!-- .element: class="fragment current-visible" data-fragment-index="5" -->


![Multimodal representation models](./figures/intro-to-multimodal/representation-models.svg) <!-- .element: class="fragment current-visible" data-fragment-index="6" -->


Race model of mulitmodal decision making <!-- .element: class="fragment current-visible" data-fragment-index="7" -->

![Race model intergation model](./figures/decision-models/late-integration-2.png) <!-- .element: class="fragment current-visible" data-fragment-index="7" -->


Drift model of mulitmodal decision making <!-- .element: class="fragment current-visible" data-fragment-index="7" -->

![Drift model integraation model](./figures/decision-models/late-integration-1.png) <!-- .element: class="fragment current-visible" data-fragment-index="7" -->

Early integration model of multimoda decision making <!-- .element: class="fragment current-visible" data-fragment-index="8" -->

![Early integration model](./figures/decision-models/early-integration.png) <!-- .element: class="fragment current-visible" data-fragment-index="8" -->
...
![Presentation matrix](./figures/filmworld/presentation-matrix.svg) <!-- .element  width="100%"; style="margin:auto;display:block" -->
...
![TS003 audio/video decoding SVM](./figures/filmworld/2p/TS003/2019-11-28/exp-2/av-classification/simple-svm-cv-split-classfication-accuracy.png) <!-- .element  width="100%"; style="margin:auto;display:block" -->

</div>

<div id='right'> 

![Presentation matrix](./figures/filmworld/presentation-matrix.svg) <!-- .element  height=80%; style="margin:auto;display:block" -->
...
![Reliability](./figures/filmworld/correlation/reliability/TS004_interval_experiment_all_neuron_corr_and_reliability.svg) <!-- .element  width="100%"; style="margin:auto;display:block" --> 
...
![Reliable visual neuron](./figures/filmworld/correlation/reliability/video_reliability_plane_5_cell_95.svg) <!-- .element  width="100%"; style="margin:auto;display:block" --> 
...
'Reliable' audio neuron 

![Reliable audio neuro](./figures/filmworld/correlation/reliability/audio_reliability_plane_11_cell_245.svg) <!-- .element  width="100%"; style="margin:auto;display:block" --> 
...
![Motion energy](./figures/filmworld/motion/TS004_interval_ROI_motion_energy.png)
...
![Audio affects movement](./figures/filmworld/motion/audio-affect-movement.svg)
...
![Suite2p](./figures/citations/suite2p_logo.png) <!-- .element  width="20%"; style="margin:auto;display:block" -->
 
![Xarray logo](./figures/citations/xarray_logo.png) <!-- .element  width="60%"; style="margin:auto;display:block" -->
